    ...
    if chat_id in user_states:
        ...
        if state == "adding_wallet_amount":
            try:
                ...
                await message.reply_text("لطفاً مقدار مورد نظر کیف پول خود را به شماره کارت زیر واریز بکنید و سپس عکس واریزی را ارسال کنید❤️🙏🏻\5892-1015-4456-9201\nیزدانی")
            except ValueError:
...
async def process_buy_config_open(client, callback_query):
    ...
    if user_wallet and user_wallet[0] >= plan_price:
        ...
        await callback_query.message.reply_text("موجودی کیف پول شما کافی نیست.برای خرید کانفیگ به شماره کارت زیر واریز کنید و عکس پرداخت رو ارسال کنید و یا موجودی کیف پول خود را افزایش دهید❤️🙏🏻\5892-1015-4456-9201\nیزدانی")
...
async def process_buy_config_v2ray(client, callback_query):
    ...
    if user_wallet and user_wallet[0] >= plan_price:
        ...
        await callback_query.message.reply_text(
            "موجودی کیف پول شما کافی نیست. برای خرید کانفیگ به شماره کارت زیر واریز کنید و عکس پرداخت را ارسال کنید و یا موجودی کیف پول خود را افزایش دهید❤️🙏🏻\5892-1015-4456-9201\nیزدانی"
        )
